...
import { Calendar, CircleEllipsis, Plus, UserRound } from "lucide-react";

const Task = ({ onOpenCreateModal }) => {
  const tasks = [
    {
      id: 1,
    ...
    },
    {
      ...
      description:
        "Improve the dashboard layout and make the components responsive.",
    ...
    },
    {
      ...
      description:
        "Prepare API documentation for the newly implemented task endpoints.",
      employee: "Alex Brown",
      status: "Done",
      priority: "Low",
      date: "09/28/2026",
  ...
  return (
    <div className="w-full h-full min-h-0 p-4 sm:p-6 lg:p-8 text-gray-300 flex flex-col overflow-hidden">
      {/* Header */}
